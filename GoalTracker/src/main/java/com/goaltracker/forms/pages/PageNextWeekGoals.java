/*
 * PageDueNextWeek.java
 * - display goals due next week page
 *
 * Tyler Moquin
 *
 * VERSION HISTORY
...
public class PageNextWeekGoals extends JPanel implements Page {

    public PageNextWeekGoals() {
        initComponents();
        ...
        if (goals != null) {
            ...
            if (count > 0) {
                for (int i = count - 1; i >= 0; i--) {
                    ...
                    if (g.getIsSubGoal() == false && !(g.getIsAbandoned()) && !(g.getIsCompleted()) && (days >= 6 && days <= 14)) {
    ...
    private void initComponents() {
        ...
        newGoalLabel.setText("Due Next Week");
