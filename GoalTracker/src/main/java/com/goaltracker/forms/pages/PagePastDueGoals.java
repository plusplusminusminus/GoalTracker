/*
 * PagePastDueGoals.java
 * - display past due goals page
 *
 * Tyler Moquin
 *
 * VERSION HISTORY
...
public class PagePastDueGoals extends JPanel implements Page {

    public PagePastDueGoals() {
        initComponents();
        ...
        if (goals != null) {
            ...
            if (count > 0) {
                for (int i = count - 1; i >= 0; i--) {
                    ...
                    if (g.getIsSubGoal() == false && !(g.getIsAbandoned()) && !(g.getIsCompleted()) && (days < 0)) {
