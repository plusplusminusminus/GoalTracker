/*
 * PageThisWeekGoals.java
 * - display this week's goals page
 *
 * Tyler Moquin
 *
 * VERSION HISTORY
...
public class PageThisWeekGoals extends JPanel implements Page {

    public PageThisWeekGoals() {
        initComponents();
        ...
        if (goals != null) {
            ...
            if (count > 0) {
                for (int i = count - 1; i >= 0; i--) {
                    ...
                    if (g.getIsSubGoal() == false && !(g.getIsAbandoned()) && !(g.getIsCompleted()) && (days >= 0 && days <= 7)) {
    ...
    private void initComponents() {
        ...
        newGoalLabel.setText("Due This Week");
